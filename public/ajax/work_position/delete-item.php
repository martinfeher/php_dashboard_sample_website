<?php
     ...
     * Description: Delete item to db table php_sample_dashboard_website.work_position
     * Return: string
     *
     */
        ...
        if(@isset($_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_REFERER']===$app['domain'] . '/work_position.php') {
            ...
            if($headers['Csrf-Token'] == $_SESSION['Csrf-Token']) {
                ...
                try {
                    ...
                    $sql = "DELETE FROM php_sample_dashboard_website.work_position WHERE uuid = :uuid;";
